...
doc ///
  ...
  Description
    Text
      Define the min reduction here.  WRITE THIS NODE!
    Example
      R = QQ[a..d];
  SeeAlso
    reductionNumber
...
doc ///
  ...
  Description
    Text
      Define the reduction number here.  WRITE THIS NODE!
    Example
      R = QQ[a..d];
  SeeAlso
    minimalReduction
...
doc ///
  ...
  Description
    Text
      Define Gm condition here.  WRITE THIS NODE!
    Example
      R = QQ[a..d];
  SeeAlso
    minimalReduction
